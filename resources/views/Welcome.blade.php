    ...
    <section id="hero" class="d-flex flex-column justify-content-center">
        <div class="container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div class="social-links">
                <a href="https://twitter.com/loverquist" class="twitter"><i class="bx bxl-twitter"></i></a>
                <a href="https://www.instagram.com/chanrifkaa/" class="instagram"><i class="bx bxl-instagram"></i></a>

                <a href="https://id.linkedin.com/in/chantikka-rahmadhani-52b83b250" class="linkedin"><i class="bx bxl-linkedin"></i></a>
            </div>
        </div>
    </section><!-- End Hero -->
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>About</h2>
                    <p>It takes excruciating pain to gain. Her need resulted from something completely driving her away.
                        Let them be what they want. Whoever anyone wants. And neither one stands in the way of accepting
                        another. Because she had to escape in this convenience office, which was here.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content">
                        <h3>UI/UX Designer &amp; Data Analyst.</h3>
                        <p class="fst-italic">
                            It is important to take care of the patient, to be followed by the doctor, but it is a time
                            of great pain and suffering.
                        </p>
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>13 November
                                            2002</span></li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                        <span>www.caca.com</span>
                                    </li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+62 3312 2344
                                            766</span></li>
                        ...
                        <p>
                            Therefore, choosing the services of labor and pains is the choice of the services. Anyone
                            can get everything and that. There are no complaints from the prosecutors about their
                            services at the time. And all his Because of desire, as said, most offices indeed. But those
                            who are not to be repulsed will therefore be pursued. Something really interesting to look
                            for with desire. And from him who is repulsed by all the guilt of great praise the pains.
                        </p>
                    </div>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    ...
                    <p>It takes great pains to benefit. His needs result from something that actually drives him away.
                        Let them be what they want. Anyone whom anyone desires. And no one who hinders receives the
                        others. Because he should flee in this office of convenience, which is here.</p>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    @foreach($categories as $c)
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-{{$c->name}}">
                            <div class="portfolio-wrap">
                                <img src="{{ URL::asset('/file/' . @$p->image_file_url) }}" class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>{{ $p->title }}</h4>
                                    <p>{{ $p->description }}</p>
                                    <div class="portfolio-links">
                                        <a href="{{ URL::asset('/file/' . @$p->image_file_url) }}"
                                            data-gallery="portfolioGallery" class="portfolio-lightbox"
                                            title="Web 3"><i class="bx bx-plus"></i></a>
                                        <a href="{{ $p->url }}" class="portfolio-details-lightbox"
